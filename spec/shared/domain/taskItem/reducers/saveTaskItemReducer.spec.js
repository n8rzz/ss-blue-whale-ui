...
ava('saveTaskItem reducer goes into loading state until data is resolved', t => {
    t.notThrows(() => {
        reducer(undefined, {
...
ava('saveTaskItem reducer sets payload', t => {
    t.notThrows(() => {
        reducer(undefined, {
...
ava('saveTaskItem reducer handles network errors by returning error state', t => {
    const networkError = new Error('network error');
    t.notThrows(() => {
        reducer(undefined, {
            type: SAVE_TASK_ITEM_FAIL,
            errors: networkError
        });
    });
